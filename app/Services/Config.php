        ...
        switch ($type) {
            case 'obfs':
				...
				if(Config::get('enable_old_mode')=='true'){
					array_push($list, 'http_simple', 'http_simple_compatible', 'http_post', 'http_post_compatible',
                ...
                return $list;
            case 'protocol':
				$list=array('origin', 'auth_sha1_v4_compatible');
				if(Config::get('enable_old_mode')=='true'){
            ...
            case 'allow_none_protocol':
				$list=array();
				if(Config::get('enable_old_mode')=='true'){
					array_push($list, 'auth_chain_a', 'auth_chain_b','auth_chain_c','auth_chain_d','auth_chain_e','auth_chain_f');
				}
                return $list;

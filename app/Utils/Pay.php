    ...
    private static function codepay_html($user)
    {
        return '
                        ...
                        <form name="codepay" action="/user/code/codepay" method="get">
                            ...
                            <br>
                            <button class="btn btn-flat waves-attach" id="btnSubmit" type="submit" name="type" value="1" ><img src="/images/alipay.png" width="50px" height="50px" /></button>
                            <button class="btn btn-flat waves-attach" id="btnSubmit" type="submit" name="type" value="2" ><img src="/images/qq.png" width="50px" height="50px" /></button>
                            <button class="btn btn-flat waves-attach" id="btnSubmit" type="submit" name="type" value="3" ><img src="/images/wechat.png" width="50px" height="50px" /></button>

...
//sing-box 的 override_android_vpn 仅 Android 支持，按订阅客户端 User Agent 判断
$isSfaVisitor = str_contains($_SERVER['HTTP_USER_AGENT'] ?? '', 'SFA');
...
$_ENV['SingBox_Config'] = [
    ...
    'route' => [
        ...
        'override_android_vpn' => $isSfaVisitor,

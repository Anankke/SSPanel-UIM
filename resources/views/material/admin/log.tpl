...
<div class="page-wrapper">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <a class="text-blue" href="#"
                                                    onclick="markedAsProcessed('{$log->id}')">标记</a>
                                            </td>
                                            {foreach $details['field'] as $key => $value}
                                                <td>{$log->$key}</td>
                                            {/foreach}
    ...
    <script>
        function adjustStyle() {
            $("td:contains('已处理')").css("color", "green");
            $("td:contains('未处理')").css("color", "red");
            $("td:contains('middle')").css("color", "orange");
        ...
        function markedAsProcessed(id) {
            item_id = id;
            action = 'update';

            $('#notice-message').text('确定要标记为已处理么');
            $('#notice-dialog').modal('show');
        }

                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-10 col-md-push-1">
															...
															<script async src="https://telegram.org/js/telegram-widget.js?4" data-telegram-login="hihmm_bot" data-size="medium" data-onauth="onTelegramAuth(user)" data-request-access="write"></script>

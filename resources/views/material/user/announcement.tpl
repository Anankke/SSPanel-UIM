						...
						<div class="card-main">
							...
							<div class="card-inner margin-bottom-no">
								...
								<div class="tab-pane fade active in page-course" id="all_ssr_windows">
									...
									<p><img src="/images/c_win_1.jpg" /></p>
									<p><code><font size="5">2：导入节点（三种方式）</font></code></p>
									<p><img src="/images/c_win_2.jpg" /></p>
									<p><img src="/images/c_win_3.jpg" /></p>
									<p><img src="/images/c_win_4.jpg" /></p>
									<p><code><font size="5">3：选择一个想用的节点，打开浏览器输入Google.com</font></code></p>
									<p><img src="/images/c_win_5.jpg" /></p>
								</div>
								...
								<div class="tab-pane fade page-course" id="all_ssr_router">
									<h2 class="major">路由器</h2>


								</div>
								<div class="tab-pane fade page-course" id="all_ssr_game">

				...
				<div class="ui-card-wrap">
						...
						<div class="col-xx-12 col-xs-6 col-lg-3">
								<div class="card user-info">
									<div class="user-info-main">
										<div class="nodemain">
											<div class="nodehead node-flex">
												<div class="nodename">Account Grade</div>
												<a href="/user/shop" class="card-tag tag-orange">Upgrade</a>
											</div>
									...
									<div class="user-info-bottom">
										...
										{if $user->class!=0}
											<span><i class="icon icon-md">add_circle</i>Expired traffic clear</span>
										{else}
										    <span><i class="icon icon-md">add_circle</i>Upgrade to unlock the VIP node</span>
										{/if}
										</div>
									</div>
								</div>
							...
							<div class="col-xx-12 col-xs-6 col-lg-3">
								<div class="card user-info">
									<div class="user-info-main">
										<div class="nodemain">
											<div class="nodehead node-flex">
												<div class="nodename">Balance</div>
												<a href="/user/code" class="card-tag tag-green">Recharge</a>
											</div>
											<div class="nodemiddle node-flex">
												<div class="nodetype">
													{$user->money} CNY
									...
									<div class="user-info-bottom">
										<div class="nodeinfo node-flex">
											<span href="/user/shop"><i class="icon icon-md">attach_money</i>Available balance</span>
										</div>
									</div>
								</div>
							</div>
							<div class="col-xx-12 col-xs-6 col-lg-3">
								<div class="card user-info">
									<div class="user-info-main">
										<div class="nodemain">
											<div class="nodehead node-flex">
												<div class="nodename">Number of online devices</div>
											</div>
											<div class="nodemiddle node-flex">
												<div class="nodetype">
													...
													{else}
													<dd>{$user->online_ip_count()} / Unlimited </dd>
													{/if}
												</div>
											</div>
										</div>
									...
									<div class="user-info-bottom">
										<div class="nodeinfo node-flex">
											<span><i class="icon icon-md">donut_large</i>Online Device / Device Limit</span>
										</div>
									</div>
								</div>
							</div>
							<div class="col-xx-12 col-xs-6 col-lg-3">
								<div class="card user-info">
									<div class="user-info-main">
										<div class="nodemain">
											<div class="nodehead node-flex">
												<div class="nodename">Port Speed</div>
											</div>
											<div class="nodemiddle node-flex">
												<div class="nodetype">
									...
									<div class="user-info-bottom">
										<div class="nodeinfo node-flex">
											<span><i class="icon icon-md">signal_cellular_alt</i>Highest download speed</span>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-xx-12 col-sm-8">
							...
							<div class="card">
								<div class="card-main">
                                    ...
                                    <p class="card-heading"> <i class="icon icon-md">notifications_active</i>Latest Announcements</p>
										{if $ann != null}
										<p>{$ann->content}</p>
										<br/>
										<strong><a href="/user/announcement"/>Click here</a>  for other announcements.</strong>
										{/if}
										{if $config["enable_admin_contact"] == 'true'}
										<p class="card-heading">Administrator contact information</p>
							...
							<div class="card quickadd">
								<div class="card-main">
									...
									<div class="cardbtn-edit">
											<div class="card-heading"><i class="icon icon-md">phonelink</i> Quick Add Node</div>
											<div class="reset-flex"><span>Reset subscription link</span><a class="reset-link btn btn-brand-accent btn-flat" ><i class="icon">autorenew</i>&nbsp;</a></div>
									</div>
											...
											<div class="tab-content">
												<div class="tab-pane fade {if $ssr_prefer}active in{/if}" id="all_ssr">
													...
													<nav class="tab-nav margin-top-no">
														<ul class="nav nav-list">
                                                          ...
                                                          <li>
             												...
             												<li>
																<a class="" data-toggle="tab" href="#all_ssr_info"><i class="icon icon-lg">info_outline</i>&nbsp;Connection Details</a>
															</li>
														</ul>
													</nav>
													...
													<div class="tab-pane fade active in" id="all_ssr_windows">
														...
														<p><span class="icon icon-lg text-white">filter_1</span><a class="btn-dl" href="/ssr-download/ssr-win.7z"><i class="material-icons">save_alt</i> Click to download SSRR</a> to extract to any disk and run.</p>
														<p><span class="icon icon-lg text-white">filter_2</span> In the lower right corner of the taskbar, right click on the aircraft icon -> Server Subscription -> SSR Server Subscription Settings, set the subscription link to the following address, and then update the SSR Server subscription.</p>
														<p> <span class="icon icon-lg text-white">filter_3</span> Then select a suitable server, the proxy rule select "bypass LAN and mainland", then you can go online.</p>
														<p><span class="icon icon-lg text-white">filter_4</span> Alternate import node method: Click to copy<a class="copy-text btn-dl" data-clipboard-text="{$ssr_url_all}"><i class="material-icons icon-sm">how_to_vote</i>default port link</a> or <a class="copy-text btn-dl" data-clipboard-text="{$ssr_url_all_mu}"><i class="material-icons icon-sm">how_to_vote</i>Single port multi-user link</a>, then right click on the plane -> copy the address from the clipboard.</p>

														<div><span class="icon icon-lg text-white">flash_auto</span> {if $mergeSub!='true'}Default node {/if} subscription address:</div>
														<div class="float-clear"><input type="text" class="input form-control form-control-monospace cust-link col-xx-12 col-sm-8 col-lg-7" name="input1" readonly value="{$subUrl}{$ssr_sub_token}?mu=0" readonly="true"><button class="copy-text btn btn-subscription col-xx-12 col-sm-3 col-lg-2" type="button" data-clipboard-text="{$subUrl}{$ssr_sub_token}?mu=0">Copy</button><br></div>
														{if $mergeSub!='true'}
														<div><span class="icon icon-lg text-white">flash_auto</span> Single port node subscription address:</div>
														<div class="float-clear"><input type="text" class="input form-control form-control-monospace cust-link col-xx-12 col-sm-8 col-lg-7" name="input1" readonly value="{$subUrl}{$ssr_sub_token}?mu=1" readonly="true"><button class="copy-text btn btn-subscription col-xx-12 col-sm-3 col-lg-2" type="button" data-clipboard-text="{$subUrl}{$ssr_sub_token}?mu=1">Copy</button><br></div>
														{/if}

                                                       <p><a href="/user/tutorial">Click here to view the Windows tutorial</a></p>
													</div>
                                                  ...
                                                  <div class="tab-pane fade" id="all_ssr_info">
														...
														<dl class="dl-horizontal">
                                                          <p><dt><code>Import the default port first, and import the single port if the default port cannot be used.</code></dt></p>
															<p><dt>Port</dt>
															<dd>{$user->port}</dd></p>
															<p><dt>Password</dt>
															<dd>{$user->passwd}</dd></p>
															...
															<dd>{$user->obfs}</dd></p>
															<p><dt>Custom obfuscation parameters</dt>
															<dd>{$user->obfs_param}</dd></p>
														</dl>
														{else}
															<p>Your current encryption, obfuscation, or protocol settings cannot be connected under the ShadowsocksR client. Please use the Shadowsocks client to connect, or go to the data editing page to modify it and then check it out</p>
															<p>At the same time, ShadowsocksR single-port multi-user connections are not affected by your settings, you can connect with the appropriate client here~</p>
															<p>Please note that your SSR subscription link has expired in the current state and you cannot import nodes in this way</p>
														{/if}
													</div>
												</div>
												...
												<div class="tab-pane fade {if !$ssr_prefer}active in{/if}" id="all_ss">
													<nav class="tab-nav margin-top-no">
														<ul class="nav nav-list">
															...
															<li>
																<a class="" data-toggle="tab" href="#all_ss_router"><i class="icon icon-lg">router</i>&nbsp;Router</a>
															</li>
															<li>
																<a class="" data-toggle="tab" href="#all_ss_info"><i class="icon icon-lg">info_outline</i>&nbsp;Connection Details</a>
															</li>
														</ul>
													</nav>
													<div class="tab-pane fade" id="all_ss_info">
														...
														<dl class="dl-horizontal">
															<p>The address of node can be viewed in the node list!</p>
															<p><dt>Port</dt>
															<dd>{$user->port}</dd></p>
															<p><dt>Password</dt>
															<dd>{$user->passwd}</dd></p>
														...
														{else}
															<p Your current encryption method, confusion, or protocol settings cannot be connected under the SS client. Please use the SSR client to connect, or go to the data editing page to modify it and then check it out</p>
															<p>At the same time, Shadowsocks single-port multi-user connections are not affected by your settings, you can connect with the appropriate client here~</p>
														{/if}
													</div>
						...
						<div class="col-xx-12 col-sm-4">
							...
							<div class="card">
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
										<p class="card-heading"><i class="icon icon-md">account_circle</i>Account Details</p>
										<dl class="dl-horizontal">
											...
											<dd><i class="icon icon-md">event</i>&nbsp;{$user->class_expire}</dd>
                                              {else}
                                              <dd><i class="icon icon-md">event</i>&nbsp;Unlimited</dd>
                                              {/if}
											</p>
                                          	<p><dt>Grade validity period</dt>
                                              <i class="icon icon-md">event</i>
                                              <span class="label-level-expire">Remain</span>
											  <code><span id="days-level-expire"></span></code>
                                              <span class="label-level-expire">days</span>
                                            </p>

											<p><dt>Account expiration date</dt>
											  <dd><i class="icon icon-md">event</i>&nbsp;{$user->expire_in}</dd>
                                            </p>
                                            <p><dt>Account validity period</dt>
                                              <i class="icon icon-md">event</i>
                                              <span class="label-account-expire">Remain</span>
											  <code><span id="days-account-expire"></span></code>
											  <span class="label-account-expire">days</span>
                                           </p>

											<p><dt>Last connected</dt>
                                              {if $user->lastSsTime()!="Never used"}
											<dd><i class="icon icon-md">event</i>&nbsp;{$user->lastSsTime()}</dd>
                                              {else}
                                              <dd><i class="icon icon-md">event</i>&nbsp;Never used</dd>
                                              {/if}</p>
                                            <p><dt>Last check-in time</dt>
									...
									<div class="card-action">
										<div class="usercheck pull-left">
											{if $user->isAbleToCheckin() }
												...
												<div id="checkin-btn">
													<button id="checkin" class="btn btn-brand btn-flat"><span class="icon">check</span>&nbsp;Click to check in&nbsp;
													<div><span class="icon">screen_rotation</span>&nbsp;or shake the phone to check in</div>
													</button>
												</div>
											...
											{else}
												...
												<p><a class="btn btn-brand disabled btn-flat" href="#"><span class="icon">check</span>&nbsp;Checked in today</a></p>
                                       ...
                                       <script src="/assets/js/canvasjs.min.js"> </script>
                                         ...
                                         theme: "light1",
												...
												data: [
												{
													...
													dataPoints: [
														...
														{
															y: {$user->last_day_t/$user->transfer_enable*100},label: "Used", legendText:"Used {number_format($user->last_day_t/$user->transfer_enable*100,2)}% {$user->LastusedTraffic()}", indexLabel: "Used {number_format($user->last_day_t/$user->transfer_enable*100,2)}% {$user->LastusedTraffic()}"
														},
														{
															y: {($user->u+$user->d-$user->last_day_t)/$user->transfer_enable*100},label: "Today", legendText:"Today {number_format(($user->u+$user->d-$user->last_day_t)/$user->transfer_enable*100,2)}% {$user->TodayusedTraffic()}", indexLabel: "Today {number_format(($user->u+$user->d-$user->last_day_t)/$user->transfer_enable*100,2)}% {$user->TodayusedTraffic()}"
														},
														{
															y: {($user->transfer_enable-($user->u+$user->d))/$user->transfer_enable*100},label: "Left", legendText:"Left {number_format(($user->transfer_enable-($user->u+$user->d))/$user->transfer_enable*100,2)}% {$user->unusedTraffic()}", indexLabel: "Left {number_format(($user->transfer_enable-($user->u+$user->d))/$user->transfer_enable*100,2)}% {$user->unusedTraffic()}"
														}
														{/if}
													]
												}
										...
										<div class="progressbar">
											 ...
											 <div class="label-flex">
												<div class="label la-top"><div class="bar ard color3"><span></span></div><span class="traffic-info">Today</span><code class="card-tag tag-red">{$user->TodayusedTraffic()}</code></div>
											 </div>
										</div>
										<div class="progressbar">
										    <div class="before"></div>
										    ...
										    <div class="label-flex">
										       <div class="label la-top"><div class="bar ard color2"><span></span></div><span class="traffic-info">Used</span><code class="card-tag tag-orange">{$user->LastusedTraffic()}</code></div>
										    </div>
								        </div>
										<div class="progressbar">
											<div class="before"></div>
											...
											<div class="label-flex">
											   <div class="label la-top"><div class="bar ard color"><span></span></div><span class="traffic-info">Left</span><code class="card-tag tag-green" id="remain">{$user->unusedTraffic()}</code></div>
											</div>
									   </div>
...
function CountDown() {
    ...
    if (levelExpireDays < 0 || levelExpireDays > 315360000000) {
        document.getElementById('days-level-expire').innerHTML = "Unlimited";
    ...
    if (accountExpireDays < 0 || accountExpireDays > 315360000000) {
        document.getElementById('days-account-expire').innerHTML = "Unlimited";
...
$(".copy-text").click(function () {
	$("#result").modal();
	$("#msg").html("The subscription link has been copied, please proceed to the next step.");
});
$(function(){
...
$(".reset-link").click(function () {
	$("#result").modal();
	$("#msg").html("Your subscription link has been reset, please change or add your subscription link!");
...
window.onload = function() {
    $("#result").modal();
    $("#msg").html("Your traffic has been used up or your account has expired. If you need to continue using it, please go to the store to purchase a new package~");
};
 {/if}

{if $geetest_html == null}

var checkedmsgGE = '<p><a class="btn btn-brand disabled btn-flat waves-attach" href="#"><span class="icon">check</span>&nbsp;Checked</a></p>';
window.onload = function() {

								...
								<div class="form-group">
									<div class="row">
										<div class="col-md-10 col-md-push-1">
											...
											<button id="close" type="submit" class="btn btn-block btn-brand-accent">Add and close</button>
                      <button id="close_directly" type="submit" class="btn btn-block btn-brand-accent waves-attach waves-light">Close</button>

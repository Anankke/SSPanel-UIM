...
ALTER TABLE `user_invite_code` DROP INDEX `ss_invite_code_ibfk_1`;
...
ALTER TABLE `detect_log` DROP INDEX `detect_log_ibfk_5`;
...
ALTER TABLE `node_info` DROP INDEX `ss_node_info_ibfk_2`;
...
ALTER TABLE `node_online_log` DROP INDEX `ss_node_online_log_ibfk_3`;
